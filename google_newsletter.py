# this script is an example of how to use the langchain and crewai libraries to create a crew of agents that will work together to create a newsletter about the latest AI tools and projects.
# the first agent, explorer, will use the GoogleSerperAPIWrapper to scrape the internet for the latest AI tools and projects.
# the second agent, writer, will use the scraped data to write a blog post about the latest AI tools and projects.
# the third agent, critique, will provide feedback on the blog post drafts to make sure that the tone and writing style is compelling, simple and concise.
...
# for sending google searches
from langchain_community.utilities import GoogleSerperAPIWrapper

# to use the OpenAI API (GPT-4), you need to set your API key as an environment variable
#api = os.environ.get('OPENAI_API_KEY')
# to change the OpenAI Model, you need to set MODEL_NAME in .env file
#print('API KEY: ', api)
